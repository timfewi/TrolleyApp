...
namespace Trolley.API.Migrations
{
    ...
    [Migration("20231213124424_PropToTempProduct")]
    partial class PropToTempProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "2d6d60c8-ae2b-47c5-a7e8-50535cf5bfb8",
                            RoleId = "1d6d60c8-ae2b-47c5-a7e8-50535cf5bfb8"
                        });
                });
            ...
            modelBuilder.Entity("Trolley.API.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2d6d60c8-ae2b-47c5-a7e8-50535cf5bfb8",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4fdf5745-c241-4cb4-a6f7-274b8f366998",
                            Email = "admin@example.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@EXAMPLE.COM",
                            NormalizedUserName = "ADMIN@EXAMPLE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEHG8AZjpOg51rOMgcWwMjbmL5xpFjAfgDWPy61oxAYr17+CsMAIhIgJlmb56yvnQeg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2addd034-7008-4c2d-9866-085eb9f7ed70",
                            TwoFactorEnabled = false,
                            UserName = "admin@example.com"
                        });
                });

            modelBuilder.Entity("Trolley.API.Entities.BlockedMarket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trolley.API.Entities.Donation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Trolley.API.Entities.TempProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TempProducts");
                });

            modelBuilder.Entity("Trolley.API.Entities.UserShoppingList", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("AppUserId", "ShoppingListId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Trolley.API.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Trolley.API.Entities.BlockedMarket", b =>
                {
                    b.HasOne("Trolley.API.Entities.AppUser", "AppUser")
                        .WithMany("BlockedMarkets")
            ...
            modelBuilder.Entity("Trolley.API.Entities.Donation", b =>
                {
                    b.HasOne("Trolley.API.Entities.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("AppUserId");
